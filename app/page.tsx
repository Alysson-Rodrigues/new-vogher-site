...
export default function Page() {
  return (
    ...
    <div>
      ...
      <div className="w-full p-16 z-10">
          <h2 className="text-6xl text-black font-base-neue-bold text-center lg:text-center">Design matters... we can handle it.</h2>
          <p className="text-3xl text-black font-base-neue-regular text-center lg:text-center">We count on the best on the design market to find the best solution for you</p>
        </div>
        <Badge
