  ...
  return (
    <>
      <div>
        ...
        style={
          {
            backgroundImage: 'url("/assets/backgrounds/colored.png")',
            backgroundRepeat: 'no-repeat',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          }
        } className="p-16 lg:p-0 lg:px-8 lg:flex-col flex justify-start items-center colored-section">
          <div className="p-8 z-10 bg-white mt-16 mb-4 border-4 border-black rounded-md">
            <h2 className="text-4xl text-black  font-base-neue-bold text-center lg:text-center border-spacing-2">Review Gallery</h2>
            <p className="text-2xl text-black font-base-neue-regular text-center lg:text-center">What costumers have said about us:</p>
          </div>
          <div className="w-full flex p-8 justify-center">
            <Badge
              className='w-[30%] bg-[#151515]'
